...
/**
 * A simple interface which is able to do something when a server is loaded from the SharedPreference.
 * The intend of this interface is to reuse the loading preference algorythme but without any coupling to
...
public interface PreferenceProcessor {
	 ...
	 * @param idP The unique ID of the current read server
