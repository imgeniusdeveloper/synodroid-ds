...
public enum TaskSort {
	TASK_ID(R.string.label_sort_taskid),
	FILENAME(R.string.label_sort_filename),
	TOTAL_SIZE(R.string.label_sort_totalsize),
	CURRENT_SIZE(R.string.label_sort_currentsize),
