      ...
      Runnable runnable = new Runnable() {
        public void run() {
          try {
            ...
            if (actionQueueP != null) {
              for (SynoAction taskAction : actionQueueP) {
                executeAsynchronousAction(handlerP, taskAction, false);
              }
            }
          ...
          // Connection error
            ...
            if (connected) {
              fireMessage(SynoServer.this.handler, ResponseHandler.MSG_ERROR,
                      translateError(SynoServer.this.handler, e));
            }
          }
